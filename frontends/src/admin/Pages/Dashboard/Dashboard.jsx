...
const Dashboard = () => {
  ...
  useEffect(() => {
    axiosInstanceAdmin
      .get(`/api/admin/monthly-revenue`, { withCredentials: true})
      .then((response) => {
  ...
  useEffect(() => {
    axiosInstanceAdmin
      .get(`/api/admin/booking-status`, { withCredentials: true})
      .then((response) => {
        if (response.data.success && response.data.data) {
  ...
  useEffect(() => {
    axiosInstanceAdmin
      .get(`/api/admin/monthly-bookings`, { withCredentials: true })
      .then((response) => {
        if (response.data.success && response.data.data) {
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          ...
          >
            <CardContent>
              <Typography variant="h6" gutterBottom>
                <FaCar size={30} style={{marginRight:5, marginBottom:-10}}/>
                Total Rides
              </Typography>
         ...
         <Grid item xs={12} sm={6} md={3}>
          ...
          >
            <CardContent>
              <Typography variant="h6" gutterBottom>
                <RiSteering2Fill size={30} style={{marginRight:5, marginBottom:-10}}/>
                Total Drivers
              </Typography>
        ...
        <Grid item xs={12} sm={6} md={3}>
          ...
          >
            <CardContent>
              <Typography variant="h6" gutterBottom>
                <FaBook size={30} style={{marginRight:5, marginBottom:-10}}/>
                Total Bookings
              </Typography>
        ...
        <Grid item xs={12} sm={6} md={3}>
          ...
          >
            <CardContent>
              <Typography variant="h6" gutterBottom>
                <FaUsers size={30} style={{marginRight:5, marginBottom:-10}}/>
                Total Users
              </Typography>
        ...
        <Grid item xs={12} sm={6} md={3}>
          ...
          >
            <CardContent>
              <Typography variant="h6" gutterBottom>
                <FaCoins size={30} style={{marginRight:5, marginBottom:-10}}/>
                Revenue
              </Typography>
