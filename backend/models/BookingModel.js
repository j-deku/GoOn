...
const RideSchema = new mongoose.Schema(
  {
    ...
    status: { 
      type: String, 
      enum: ["pending approval", "scheduled", "approved", 
        "declined", "assigned", "in progress", "completed",
        "driver_en_route","arrived","cancelled",
      ],
      default: "pending approval",
    },
    driver: { type: mongoose.Schema.Types.ObjectId, required: true }
  },
  { _id: false }
);
...
const BookingSchema = new mongoose.Schema(
  {
    ...
    status: { 
      type: String, 
      enum: ["pending approval", "approved","partially approved", "declined", 
        "in progress", "completed","pending approval",
